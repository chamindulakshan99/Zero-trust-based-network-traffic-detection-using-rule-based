...
threshold_dst_bytes = np.percentile(normal_traffic['dst_bytes'], 96)
threshold_count = np.percentile(normal_traffic['count'], 96)
threshold_srv_count = np.percentile(normal_traffic['srv_count'], percentile_value)
threshold_duration = np.percentile(normal_traffic['duration'], 96)
threshold_diff_srv_rate = np.percentile(normal_traffic['diff_srv_rate'], 96)
threshold_dst_host_diff_srv_rate = np.percentile(normal_traffic['dst_host_diff_srv_rate'], percentile_value)
threshold_dst_host_count = np.percentile(normal_traffic['dst_host_count'], 96)
threshold_serror_rate = np.percentile(normal_traffic['serror_rate'], 96)
threshold_dst_host_serror_rate = np.percentile(normal_traffic['dst_host_serror_rate'], 96)
threshold_wrong_fragment = np.percentile(normal_traffic['wrong_fragment'], 96)
threshold_hot = np.percentile(normal_traffic['hot'], 96)
threshold_num_failed_logins = np.percentile(normal_traffic['num_failed_logins'], 96)
threshold_num_compromised = np.percentile(normal_traffic['num_compromised'], 96)
threshold_num_file_creations = np.percentile(normal_traffic['num_file_creations'], 96)
threshold_num_access_files = np.percentile(normal_traffic['num_access_files'], 96)
